<h2><a href="https://practice.geeksforgeeks.org/problems/snake-and-ladder-problem4816/1?utm_source=gfg&utm_medium=article&utm_campaign=bottom_sticky_on_article">Snake and Ladder Problem</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a <strong>5x6</strong>&nbsp;snakes and ladders board, find the minimum number of dice throws required to reach the destination or last cell (<strong>30<sup>th</sup></strong>&nbsp;cell) from the source (1st cell). </span></p>
