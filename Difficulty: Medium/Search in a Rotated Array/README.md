...
<pre><span style="font-size: 18px;"><strong>Input: </strong>n = 9, arr[] = {5, 6, 7, 8, 9, 10, 1, 2, 3}, key = 10
<strong>Output</strong>: 5
<strong>Explanation</strong>: 10 is found at index 5.</span></pre>
<pre><span style="font-size: 18px;"><strong>Input</strong>: n = 4, arr[] = {3, 5, 1, 2}, key = 6</span><span style="font-size: 18px;"><strong>
